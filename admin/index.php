...
<body class="admin-dashboard">
    ...
    <aside class="admin-sidebar">
        ...
        <nav class="admin-nav">
            ...
            <a href="faith_clinic.php" class="admin-nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <section class="admin-card list-section">
                <div class="list-header">
                    ...
                    <div class="search-small">
                        ...
                        <input type="text" id="sermonSearchInput" placeholder="Search...">
                    </div>
                </div>
    ...
    <script>
        ...
        async function fetchSermons(searchTerm = '') {
            try {
                const response = await fetch(`../api/get_sermons.php?limit=20&search=${encodeURIComponent(searchTerm)}`);
                const result = await response.json();
